      ...
      <div className="w-full max-w-md mx-auto px-6 py-12">
        <div className="text-center mb-10">
          <div className="w-20 h-20 bg-emerald-600 rounded-full mx-auto mb-4 flex items-center justify-center">
            <span className="text-white text-2xl font-bold font-[family-name:var(--font-poppins)]">P</span>
          </div>
        ...
        <div className="flex flex-col gap-3">
          {links.map((link) => (
            <Link
              ...
              className="flex items-center gap-3 w-full px-5 py-3.5 bg-white border border-slate-200 rounded-xl text-slate-800 font-medium hover:bg-emerald-50 hover:border-emerald-300 hover:text-emerald-700 transition-all duration-200 shadow-sm hover:shadow-md"
            >
              <span className="text-emerald-600">{link.icon}</span>
              <span className="flex-1 text-center pr-8">{link.label}</span>
            </Link>
          ))}
        </div>
